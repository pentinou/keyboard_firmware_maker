...
STRINGS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "oled.zmk.status_screen_only": "Mode ZMK custom OLED (Phase 2) : image plein \u00e9cran + widgets natifs ZMK. Anim QMK et overlays QMK indisponibles, en backlog.",
        "oled.zmk.use_builtin_screen": "Utiliser l'\u00e9cran built-in ZMK (layer + batterie + output)",
        "oled.zmk.show_battery_percentage": "Afficher le pourcentage de batterie en texte",
        "oled.group.zmk_widgets": "Widgets ZMK",
        "oled.zmk_widget.battery": "Batterie",
        "oled.zmk_widget.battery_show_peer": "Afficher batterie de l'autre moiti\u00e9 (split)",
        "oled.zmk_widget.output": "Sortie USB/BLE",
        "oled.zmk_widget.layer": "Couche active",
        "oled.zmk_widget.peripheral": "\u00c9tat connexion split",
        "oled.zmk_image.layer_label": "Couche image :",
        "oled.zmk_image.layer_all": "toutes",
        ...
        "hardware.zmk_debug_logging.label": "Mode debug (logs Zephyr/ZMK sur USB)",
        "hardware.zmk_debug_logging.help": "Active les logs de boot/runtime sur le port série USB CDC. Capturer avec `screen /dev/ttyACM0 115200` ou `picocom`. Augmente la taille flash et la conso BLE — à désactiver pour la prod.",
        "hardware.zmk_custom_keymap.label": "Importer un keymap personnel (Vial JSON)",
        "hardware.zmk_custom_keymap.import_btn": "Choisir fichier…",
        "hardware.zmk_custom_keymap.no_file": "Aucun fichier importé",
        "hardware.zmk_custom_keymap.loaded": "Keymap chargé ({n} layers)",
        "hardware.zmk_custom_keymap.help": "Importer un keymap exporté depuis Vial-QMK (.json). KFM convertit en ZMK best-effort : la plupart des touches sont préservées, certaines (BL_TOGG, QK_CLEAR_EEPROM, modes RGB spécifiques) deviennent &none.",
        "hardware.zmk_custom_keymap.dialog_title": "Choisir un fichier .json Vial-QMK",
        "hardware.zmk_custom_keymap.error_title": "Erreur d'import keymap",
        "hardware.zmk_custom_keymap.error_msg": "Impossible de lire le fichier : {exc}",
        "hardware.zmk_custom_keymap.invalid_format": "Le fichier n'est pas un export Vial valide (clé 'layout' manquante).",
        "hardware.zmk_custom_keymap.layers_warning_title": "Import keymap : couches ignorées",
        "hardware.zmk_custom_keymap.layers_warning_msg": "Ce keymap contient {n} couches, mais le firmware ZMK généré n'en a que 4 (default, lower, raise + couche Bluetooth KFM). Seules les 3 premières couches sont importées. Les touches MO/LT/TG/TO pointant vers une couche absente seront neutralisées à la génération.",
        ...
        "adv.section.identification": "Identification",
        "adv.section.keyboard_behavior": "Comportement clavier",
        "adv.section.bluetooth": "Bluetooth (ZMK uniquement)",
        "adv.section.energy": "Énergie",
        "adv.section.ergo": "Ergonomie & timing",
        "adv.section.rgb_advanced": "RGB avancé",
        "adv.section.pointing": "Pointing (ZMK uniquement)",
        "adv.section.mouse_keys": "Mouse keys (QMK uniquement)",
        "adv.keyboard_name.label": "Nom du clavier :",
        "adv.keyboard_name.placeholder": "ex : Sofle de Boulot",
        "adv.keyboard_name.help": "Vide = nom par défaut du firmware. Affiché dans la liste BLE/USB de l'OS.",
        "adv.nkro": "N-Key Rollover (toutes touches simultanées détectées)",
        "adv.hid_indicators": "Recevoir l'état CapsLock/NumLock/ScrollLock de l'OS",
        "adv.usb_boot": "Compatibilité BIOS (HID Boot Protocol)",
        "adv.auto_shift": "Auto-shift (maintenir touche → version shiftée)",
        "adv.auto_shift_timeout": "Délai auto-shift :",
        "adv.ble_passkey": "Pairing avec code à 6 chiffres (sécurité accrue)",
        "adv.ble_passkey.help": "Lors du pairing, l'OS affichera un code à taper sur le clavier.",
        "adv.deep_sleep_timeout": "Délai avant deep sleep :",
        "adv.battery_report_interval": "Fréquence rapport batterie :",
        "adv.soft_off": "Touche d'extinction logicielle (&soft_off)",
        "adv.tap_dance": "Tap-Dance (1 tap = X, 2 taps = Y, ...)",
        "adv.sticky_key": "Sticky keys (modificateurs one-shot)",
        "adv.tapping_term": "Tapping term :",
        "adv.combo_term": "Combo term :",
        "adv.permissive_hold": "Permissive hold (hold même si autre touche pressée)",
        "adv.rgb_hue_start": "Couleur de démarrage (HUE) :",
        "adv.rgb_on_start": "Démarrer avec RGB allumé",
        "adv.rgb_auto_off_idle": "Éteindre RGB en idle (économie batterie)",
        "adv.rgb_auto_off_usb": "Éteindre RGB quand USB débranché",
        "adv.pointing": "Support pointing (trackball / trackpoint / touchpad)",
        "adv.pointing_smooth_scroll": "Scroll haute résolution",
        "adv.mousekey_enabled": "Activer Mouse Keys",
        "adv.mousekey_delay": "Délai initial :",
        "adv.mousekey_interval": "Intervalle :",
        "adv.mousekey_max_speed": "Vitesse max :",
        "adv.tooltip.firmware_only": "{firmware} uniquement",
    },
    "en": {
        # Application
        "app.title": "keyboard_firmware_maker",
        ...
        "oled.zmk.status_screen_only": "ZMK custom OLED mode (Phase 2): full-screen image + native ZMK widgets. QMK animations and overlays unavailable, in backlog.",
        "oled.zmk.use_builtin_screen": "Use ZMK built-in screen (layer + battery + output)",
        "oled.zmk.show_battery_percentage": "Show battery percentage as text",
        "oled.group.zmk_widgets": "ZMK Widgets",
        "oled.zmk_widget.battery": "Battery",
        "oled.zmk_widget.battery_show_peer": "Show peer half battery (split)",
        "oled.zmk_widget.output": "USB/BLE output",
        "oled.zmk_widget.layer": "Active layer",
        "oled.zmk_widget.peripheral": "Split peripheral status",
        "oled.zmk_image.layer_label": "Image layer:",
        "oled.zmk_image.layer_all": "all",
        ...
        "hardware.zmk_debug_logging.label": "Debug mode (Zephyr/ZMK logs over USB)",
        "hardware.zmk_debug_logging.help": "Enables boot/runtime logs on the USB CDC serial port. Capture with `screen /dev/ttyACM0 115200` or `picocom`. Increases flash size and BLE consumption — disable for production.",
        "hardware.zmk_custom_keymap.label": "Import a custom keymap (Vial JSON)",
        "hardware.zmk_custom_keymap.import_btn": "Choose file…",
        "hardware.zmk_custom_keymap.no_file": "No file imported",
        "hardware.zmk_custom_keymap.loaded": "Keymap loaded ({n} layers)",
        "hardware.zmk_custom_keymap.help": "Import a keymap exported from Vial-QMK (.json). KFM converts to ZMK best-effort: most keys are preserved, some (BL_TOGG, QK_CLEAR_EEPROM, QMK-specific RGB modes) become &none.",
        "hardware.zmk_custom_keymap.dialog_title": "Choose a Vial-QMK .json file",
        "hardware.zmk_custom_keymap.error_title": "Keymap import error",
        "hardware.zmk_custom_keymap.error_msg": "Cannot read file: {exc}",
        "hardware.zmk_custom_keymap.invalid_format": "File is not a valid Vial export (missing 'layout' key).",
        "hardware.zmk_custom_keymap.layers_warning_title": "Keymap import: layers ignored",
        "hardware.zmk_custom_keymap.layers_warning_msg": "This keymap has {n} layers, but the generated ZMK firmware only has 4 (default, lower, raise + KFM Bluetooth layer). Only the first 3 layers are imported. MO/LT/TG/TO keys pointing to a missing layer will be neutralized at generation time.",
        ...
        "adv.section.identification": "Identification",
        "adv.section.keyboard_behavior": "Keyboard behavior",
        "adv.section.bluetooth": "Bluetooth (ZMK only)",
        "adv.section.energy": "Energy",
        "adv.section.ergo": "Ergonomics & timing",
        "adv.section.rgb_advanced": "Advanced RGB",
        "adv.section.pointing": "Pointing (ZMK only)",
        "adv.section.mouse_keys": "Mouse keys (QMK only)",
        "adv.keyboard_name.label": "Keyboard name:",
        "adv.keyboard_name.placeholder": "e.g. Work Sofle",
        "adv.keyboard_name.help": "Empty = firmware default. Shown in OS BLE/USB device list.",
        "adv.nkro": "N-Key Rollover (all keys detected simultaneously)",
        "adv.hid_indicators": "Receive CapsLock/NumLock/ScrollLock state from OS",
        "adv.usb_boot": "BIOS compatibility (HID Boot Protocol)",
        "adv.auto_shift": "Auto-shift (hold key → shifted version)",
        "adv.auto_shift_timeout": "Auto-shift timeout:",
        "adv.ble_passkey": "Pairing with 6-digit passkey (better security)",
        "adv.ble_passkey.help": "During pairing, the OS will show a code to type on the keyboard.",
        "adv.deep_sleep_timeout": "Deep sleep timeout:",
        "adv.battery_report_interval": "Battery report interval:",
        "adv.soft_off": "Software off key (&soft_off)",
        "adv.tap_dance": "Tap-Dance (1 tap = X, 2 taps = Y, ...)",
        "adv.sticky_key": "Sticky keys (one-shot modifiers)",
        "adv.tapping_term": "Tapping term:",
        "adv.combo_term": "Combo term:",
        "adv.permissive_hold": "Permissive hold (hold even if other key pressed)",
        "adv.rgb_hue_start": "Startup color (HUE):",
        "adv.rgb_on_start": "Start with RGB on",
        "adv.rgb_auto_off_idle": "Turn off RGB on idle (battery saver)",
        "adv.rgb_auto_off_usb": "Turn off RGB when USB disconnected",
        "adv.pointing": "Pointing support (trackball / trackpoint / touchpad)",
        "adv.pointing_smooth_scroll": "High-resolution scrolling",
        "adv.mousekey_enabled": "Enable Mouse Keys",
        "adv.mousekey_delay": "Initial delay:",
        "adv.mousekey_interval": "Interval:",
        "adv.mousekey_max_speed": "Max speed:",
        "adv.tooltip.firmware_only": "{firmware} only",
    },
    "it": {
        # Applicazione
        "app.title": "keyboard_firmware_maker",
        ...
        "oled.zmk.status_screen_only": "Modalit\u00e0 ZMK custom OLED (fase 2): immagine a schermo intero + widget nativi ZMK. Animazioni e overlay QMK non disponibili, in backlog.",
        "oled.zmk.use_builtin_screen": "Usa lo schermo built-in ZMK (layer + batteria + output)",
        "oled.zmk.show_battery_percentage": "Mostra la percentuale di batteria come testo",
        "oled.group.zmk_widgets": "Widget ZMK",
        "oled.zmk_widget.battery": "Batteria",
        "oled.zmk_widget.battery_show_peer": "Mostra batteria altra met\u00e0 (split)",
        "oled.zmk_widget.output": "Uscita USB/BLE",
        "oled.zmk_widget.layer": "Layer attivo",
        "oled.zmk_widget.peripheral": "Stato connessione split",
        "oled.zmk_image.layer_label": "Layer immagine:",
        "oled.zmk_image.layer_all": "tutti",
        ...
        "hardware.zmk_debug_logging.label": "Modalit\u00e0 debug (log Zephyr/ZMK su USB)",
        "hardware.zmk_debug_logging.help": "Attiva i log di boot/runtime sulla porta seriale USB CDC. Cattura con `screen /dev/ttyACM0 115200` o `picocom`. Aumenta la dimensione flash e il consumo BLE \u2014 disattivare in produzione.",
        "hardware.zmk_custom_keymap.label": "Importa un keymap personalizzato (Vial JSON)",
        "hardware.zmk_custom_keymap.import_btn": "Scegli file\u2026",
        "hardware.zmk_custom_keymap.no_file": "Nessun file importato",
        "hardware.zmk_custom_keymap.loaded": "Keymap caricato ({n} layers)",
        "hardware.zmk_custom_keymap.help": "Importa un keymap esportato da Vial-QMK (.json). KFM converte in ZMK best-effort: la maggior parte dei tasti viene preservata, alcuni (BL_TOGG, QK_CLEAR_EEPROM, modi RGB QMK-specifici) diventano &none.",
        "hardware.zmk_custom_keymap.dialog_title": "Scegli un file .json Vial-QMK",
        "hardware.zmk_custom_keymap.error_title": "Errore importazione keymap",
        "hardware.zmk_custom_keymap.error_msg": "Impossibile leggere il file: {exc}",
        "hardware.zmk_custom_keymap.invalid_format": "Il file non \u00e8 un export Vial valido (chiave 'layout' mancante).",
        "hardware.zmk_custom_keymap.layers_warning_title": "Import keymap: livelli ignorati",
        "hardware.zmk_custom_keymap.layers_warning_msg": "Questo keymap contiene {n} livelli, ma il firmware ZMK generato ne ha solo 4 (default, lower, raise + livello Bluetooth KFM). Solo i primi 3 livelli vengono importati. I tasti MO/LT/TG/TO che puntano a un livello assente saranno neutralizzati alla generazione.",
        ...
        "adv.section.identification": "Identificazione",
        "adv.section.keyboard_behavior": "Comportamento tastiera",
        "adv.section.bluetooth": "Bluetooth (solo ZMK)",
        "adv.section.energy": "Energia",
        "adv.section.ergo": "Ergonomia & timing",
        "adv.section.rgb_advanced": "RGB avanzato",
        "adv.section.pointing": "Pointing (solo ZMK)",
        "adv.section.mouse_keys": "Mouse keys (solo QMK)",
        "adv.keyboard_name.label": "Nome tastiera:",
        "adv.keyboard_name.placeholder": "es. Sofle Lavoro",
        "adv.keyboard_name.help": "Vuoto = predefinito firmware. Mostrato nell'elenco dispositivi BLE/USB.",
        "adv.nkro": "N-Key Rollover (tutti i tasti simultanei rilevati)",
        "adv.hid_indicators": "Ricevi lo stato CapsLock/NumLock/ScrollLock dall'OS",
        "adv.usb_boot": "Compatibilità BIOS (HID Boot Protocol)",
        "adv.auto_shift": "Auto-shift (mantieni tasto → versione shift)",
        "adv.auto_shift_timeout": "Tempo auto-shift:",
        "adv.ble_passkey": "Pairing con codice a 6 cifre (sicurezza migliorata)",
        "adv.ble_passkey.help": "Durante il pairing, l'OS mostrerà un codice da digitare sulla tastiera.",
        "adv.deep_sleep_timeout": "Tempo deep sleep:",
        "adv.battery_report_interval": "Intervallo report batteria:",
        "adv.soft_off": "Tasto spegnimento software (&soft_off)",
        "adv.tap_dance": "Tap-Dance (1 tap = X, 2 tap = Y, ...)",
        "adv.sticky_key": "Sticky keys (modificatori one-shot)",
        "adv.tapping_term": "Tapping term:",
        "adv.combo_term": "Combo term:",
        "adv.permissive_hold": "Permissive hold (hold anche se altro tasto premuto)",
        "adv.rgb_hue_start": "Colore di avvio (HUE):",
        "adv.rgb_on_start": "Avvia con RGB acceso",
        "adv.rgb_auto_off_idle": "Spegni RGB in idle (risparmio batteria)",
        "adv.rgb_auto_off_usb": "Spegni RGB quando USB scollegato",
        "adv.pointing": "Supporto pointing (trackball / trackpoint / touchpad)",
        "adv.pointing_smooth_scroll": "Scroll ad alta risoluzione",
        "adv.mousekey_enabled": "Abilita Mouse Keys",
        "adv.mousekey_delay": "Ritardo iniziale:",
        "adv.mousekey_interval": "Intervallo:",
        "adv.mousekey_max_speed": "Velocità massima:",
        "adv.tooltip.firmware_only": "Solo {firmware}",
    },
}
