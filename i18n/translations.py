...
STRINGS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "keyboard_editor.kle_help": "Dessinez votre clavier sur <a href='http://www.keyboard-layout-editor.com/'>keyboard-layout-editor.com</a>, puis collez le JSON ici (onglet « Raw data »). Vous pouvez aussi coller un fichier vial.json existant.",
        "keyboard_editor.kle_placeholder": "Collez ici le JSON KLE ou vial.json\u2026",
    ...
    "en": {
        ...
        "keyboard_editor.kle_help": "Design your keyboard on <a href='http://www.keyboard-layout-editor.com/'>keyboard-layout-editor.com</a>, then paste the JSON here ('Raw data' tab). You can also paste an existing vial.json file.",
        "keyboard_editor.kle_placeholder": "Paste KLE JSON or vial.json here\u2026",
    ...
    "it": {
        ...
        "keyboard_editor.kle_label": "JSON KLE (keyboard-layout-editor.com)",
        "keyboard_editor.kle_help": "Disegna la tua tastiera su <a href='http://www.keyboard-layout-editor.com/'>keyboard-layout-editor.com</a>, poi incolla il JSON qui (tab 'Raw data'). Puoi anche incollare un file vial.json esistente.",
        "keyboard_editor.kle_placeholder": "Incolla qui il JSON KLE o vial.json\u2026",
